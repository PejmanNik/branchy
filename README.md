...
Download the latest binary for your operating system from the [Releases](https://github.com/pejmannikram/git-tree/releases) page and add it to your system's `PATH`.
...
```bash
wt config set base-path ~/Developer/worktrees --global
```
